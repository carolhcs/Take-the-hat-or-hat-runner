...
/// <summary>
/// Salvar outros tipos de dados ao estilo do player prefs do unity
/// ATENÇÃO: Esse codigo foi encontrado no site http://wiki.unity3d.com/index.php/ArrayPrefs2
...
public class PlayerPrefsX
{
	...
	/// <summary>
	/// Salvar valor booleano
	/// </summary>
	/// <param name="name">string com nome da variavel</param>
	/// <param name="value">valor da variavel booleana</param>
	/// <returns></returns>
